...
const articlesData = {
    ru: [
...

        {
            ...
            title: "Продажа самолетов: премиальный выбор для требовательных покупателей",
            image: "images/background.jpg",
            excerpt: "Авиационная индустрия предоставляет уникальные возможности для бизнеса и частных лиц...",
            content: "<h2>Почему стоит купить самолет?</h2><img src='images/background.jpg' alt='Экономия времени' style='max-width:100%; height:auto; margin:15px 0;'><p>Владение воздушным судном дает неоспоримые преимущества:</p>..." ,
            author: "Команда Aviation Sales",
            date: "15 ноября 2023"
        },
        ...
        {
            id: 4,
            title: "Продажа самолетов: премиальный выбор",
            image: "images/background.jpg",
            excerpt: "Эксклюзивные бизнес-джеты и коммерческие авиалайнеры",
            content: "<h2>Наша коллекция</h2>\n<div class=\"gallery\" style=\"display: grid; grid-template-columns: repeat(auto-fill, minmax(250px, 1fr)); gap: 20px; margin: 25px 0;\">\n  <div class=\"gallery-item\" style=\"border: 1px solid #eee; border-radius: 8px; overflow: hidden;\">\n    <img src=\"images/background.jpg\" alt=\"Gulfstream G650\" style=\"width: 100%; height: 180px; object-fit: cover;\">\n    <div style=\"padding: 12px;\">\n      <h3 style=\"margin: 0 0 5px 0;\">Gulfstream G650</h3>\n      <p style=\"margin: 0; color: #555;\">Дальность: 12,000 км</p>\n      <p style=\"margin: 5px 0 0 0; font-weight: bold;\">$65M</p>\n    </div>\n  </div>\n  \n  <div class=\"gallery-item\" style=\"border: 1px solid #eee; border-radius: 8px; overflow: hidden;\">\n    <img src=\"images/background.jpg\" alt=\"Cessna Citation\" style=\"width: 100%; height: 180px; object-fit: cover;\">\n    <div style=\"padding: 12px;\">\n      <h3 style=\"margin: 0 0 5px 0;\">Cessna Citation XLS+</h3>\n      <p style=\"margin: 0; color: #555;\">Дальность: 3,500 км</p>\n      <p style=\"margin: 5px 0 0 0; font-weight: bold;\">$12M</p>\n    </div>\n  </div>\n</div>\n\n<h2>Примеры интерьеров</h2>\n<div class=\"slider\" style=\"overflow-x: auto; white-space: nowrap; padding: 15px 0; margin-bottom: 30px;\">\n  <img src=\"images/background.jpg\" alt=\"Салон\" style=\"width: 300px; height: 200px; object-fit: cover; margin-right: 15px; border-radius: 6px; display: inline-block; vertical-align: middle;\">\n  <img src=\"images/background.jpg\" alt=\"Кухня\" style=\"width: 300px; height: 200px; object-fit: cover; margin-right: 15px; border-radius: 6px; display: inline-block; vertical-align: middle;\">\n  <img src=\"images/background.jpg\" alt=\"Рабочая зона\" style=\"width: 300px; height: 200px; object-fit: cover; margin-right: 15px; border-radius: 6px; display: inline-block; vertical-align: middle;\">\n</div>",
            author: "Команда Aviation Sales",
            date: "2023-11-20",
            tags: ["бизнес-джеты", "авиация", "продажа"]
    }
